namespace C18_Ex02
{
    ...
    public partial class MatchForm : Form
    {
        ...
        //private User m_recentlySelectedUser;
        private PicAdapter m_friendPic;
        ...
        public MatchForm(User i_loggedInUser)
        {
            ...
            //this.m_recentlySelectedUser = null;
        }
        ...
        //public System.Drawing.Image ProfilePic { get { return this.m_recentlySelectedUser.ImageNormal; } }
        ...
        private void listBoxGroupA_SelectedIndexChanged(object sender, EventArgs e)
        {
            selectedFriendChanged(this.listBoxGroupA, this.pictureBoxFriendA);
        }

        private void selectedFriendChanged(ListBox i_currentListBox, PictureBox i_currentPictureBox)
        {
            this.m_friendPic = new PicAdapter(i_currentListBox.Items[i_currentListBox.SelectedIndex] as User);
            i_currentPictureBox.Image = this.m_friendPic.ProfilePic;
        }

        private void listBoxGroupB_SelectedIndexChanged(object sender, EventArgs e)
        {
            selectedFriendChanged(this.listBoxGroupB, this.pictureBoxFriendB);
        }
    }
}
